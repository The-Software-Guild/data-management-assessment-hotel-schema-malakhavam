...
/*
+------------------+--------+---------------------+--------------+
| name             | NUMBER | start_date          | total_people |
+------------------+--------+---------------------+--------------+
...
/*
+--------+---------------+-----------------+
| NUMBER | reservationID | total_room_cost |
+--------+---------------+-----------------+
|    201 |             4 |          199.99 |
|    202 |             7 |          349.98 |
|    203 |            21 |          399.98 |
...
/*
+--------+----------------+--------------------+-------------------+------------+--------------+-------------+---------------+----------------+--------+----------+---------------------+---------------------+-----------------+--------+---------+
| number | ada_accessible | standard_occupancy | maximun_occupancy | base_price | extra_person | room_typeID | reservationID | name           | adults | children | start_date          | end_date            | total_room_cost | roomNo | guestID |
+--------+----------------+--------------------+-------------------+------------+--------------+-------------+---------------+----------------+--------+----------+---------------------+---------------------+-----------------+--------+---------+
|    301 | No             |                  2 |                 4 |     199.99 |           10 |           2 |             9 | Walter Holaway |      1 |        0 | 2023-04-09 00:00:00 | 2023-04-13 00:00:00 |          799.96 |    301 |       9 |
+--------+----------------+--------------------+-------------------+------------+--------------+-------------+---------------+----------------+--------+----------+---------------------+---------------------+-----------------+--------+---------+
*/
